...
import { CreateVoteDialog, useCreateVoteDialog } from "./CreateVoteDialog";
...
export const CreateVote = () => {
    ...
    const [dataList, setDataList] = useState<Vote[]>([]);
    const [searchTerm, setSearchTerm] = useState("");

    const { openDialog } = useCreateVoteDialog();
    ...
    const fetchDataList = useCallback(async () => {
        ...
        setIsLoading(true);
        try {
            const payload = await VoteService.fetchVoteList({
        ...
        <>
            ...
            >
                <Table
                    ...
                    loading={isLoading}
                    dataSource={dataList.filter((item: Vote) =>
                    ...
                    columns={columns}
                    onRow={(record) => ({
                        onClick: () => openDialog(record, record.STATUS == "C"),
                    })}
                />
            </Card>
